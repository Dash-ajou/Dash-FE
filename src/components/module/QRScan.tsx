...
const QRScan: React.FC<QRScanProps> = ({ isPartner, onClick }) => {
    ...
    return (
        <div className="relative w-full h-screen bg-black overflow-hidden">
            ...
            {/* 안내 문구 */}
            <p
                className="absolute w-full text-center text-white text-sm z-20"
                style={{
                    top: `calc(6rem + 80vw + 16px)`,
                }}
            >
                {" "}
            ...
            <SlideUpModal isOpen={true} isFixed={true} height={"long"} title={"수동 번호 입력"}>
