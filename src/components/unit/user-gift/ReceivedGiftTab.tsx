...
import { ReceivedGift } from "../../../services/userRecivedGiftService";
import Block from "../../module/Block";
import StatusButton from "./StatusButton";

interface ReceivedGiftTabProps {
    loading: boolean;
    recivedGifts: ReceivedGift[];
}

const ReceivedGiftTab: React.FC<ReceivedGiftTabProps> = ({
    loading,
    recivedGifts,
}) => {
    if (loading) return <p>로딩 중...</p>;

    if (recivedGifts.length === 0) return <p>받은 선물이 없습니다.</p>;
