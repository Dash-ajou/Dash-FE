...
export const fetchCouponUse = async (payment_code: string): Promise<UseCouponResponse> => {
...
export const fetchCouponCancel = async (payment_code: string): Promise<CancelCouponResponse> => {
