      ...
      <div className="flex flex-col justify-center w-full">
        <div className="mt-24 flex flex-col gap-12">
          <InputField
            ...
            dropdown={false}
            notice={
              showNotice ? { detail: "올바른 전화번호 형식이 아닙니다", color: "red" } : undefined
            }
            value={phoneNum}
          ...
          <div className="flex flex-col gap-2 relative">
            <InputField
              ...
              dropdown={false}
              notice={
                showLoginFail ? { detail: "비밀번호가 올바르지 않습니다", color: "red" } : undefined
              }
              value={password}
        ...
        <div
          ...
          <CommonButton
            ...
            onClick={() => navigate("/findpw", { replace: true })}
          />
          <CommonButton
            size="mini"
            isActive={true}
            ...
            onClick={() => navigate("/join?step=roleSelect", { replace: true })}
          />
        </div>
      </div>
    </Layout>
