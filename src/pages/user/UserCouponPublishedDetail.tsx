...
import {
    fetchCouponByIssueID,
    CouponByIssueID,
} from "../../services/userCouponByIssueIdService";
...
const UserCouponPublishedDetail = () => {
    ...
    const filteredCoupons = couponList.filter((coupon) => {
        ...
        if (selectedFilter === "미등록")
            return coupon.status === "REGISTERABLE";
        return true;
    });
                ...
                <div className="relative w-full max-w-[430px] mx-auto min-h-screen">
                    <div className=" mt-2 mb-12">
                        <Statistics
                            ...
                            registered={
                                couponList.filter((c) => c.status === "USABLE")
                                    .length
                            }
                            used={
                                couponList.filter((c) => c.status === "USED")
                                    .length
                            }
                        />
                    </div>
